...
export interface LanguaDictionary {
...
export const DictornaryEnglish: LanguaDictionary = {
  bookmarks: 'Bookmarks',
...
export const DictornaryGerman: LanguaDictionary = {
  bookmarks: 'Seiten',
